    ...
    <div class="container">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('du-an'.@$news_cate->alias)}}">{{@$news_cate->name}}</a></li>                    
        ...
        <div class="row detail">
            ...
            <div class="col-xs-12 col-md-3">
                ...
                <div class="media right_sidebar">
                    <a class="pull-left" href="{{url('du-an/'.$post->alias.'.html')}}">
                        <img class="media-object" src="{{asset('upload/news/'.$post->photo)}}" alt="{{$post->name}}">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading"><a href="{{url('du-an/'.$post->alias.'.html')}}" title="">{{$post->name}}</a></h4>                        
                    </div>
                </div>
                @endforeach
            </div>            
