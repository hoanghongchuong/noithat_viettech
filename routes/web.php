...
Route::get('du-an',['as'=>'getProject', 'uses'=>'IndexController@project']);
Route::get('du-an/{alias}.html',['as'=>'getDesignDetail', 'uses'=>'IndexController@getDesignDetail']);
Route::get('du-an/{alias}',['as'=>'getListProject', 'uses'=>'IndexController@getListProject']);

Route::get('thi-cong-noi-that',['as'=>'getThiCong', 'uses'=>'IndexController@getThiCong']);
Route::get('thi-cong-noi-that/{alias}.html',['as'=>'getthiCongDetail', 'uses'=>'IndexController@getThiCongDetail']);
